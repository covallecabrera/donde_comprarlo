                    ...
                    <table align="center" width="500px" border="1" style="border-collapse:collapse;">
                        ...
                        while ($row = mysqli_fetch_array($consulta_productos)) {
                            ...
                            <tr>    
                                ...
                                ?></td>
                                <td><a onclick="seguro()" href="#">Eliminar Producto</a></td> 
                        ...
                        <script type="text/javascript">
                            function seguro(){
                                var answer = confirm("¿Seguro desea eliminar este producto?");

                                if (answer==false){
                                    alert("Ok, su producto no será eliminados"); 
                                    
                                }
                                else{
                                    window.location = "AdministrarProductosEmpresa.php?id=<?php echo $id_producto.'&'."accion=eliminar" ?>";
                                    // alert("Bueno Eliminado");                        
